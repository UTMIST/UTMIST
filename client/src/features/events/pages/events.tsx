...
import { EventItem } from "@/features/events/components/event-item";
import { SearchBar } from "@/features/events/components/search-bar";
import { TagFilter } from "@/features/events/components/tag-filter";
import { EventCard } from '@/features/events/components/event-card';
import { getUpcomingEvents, getPastEvents, getFeaturedEvents } from '@/features/events/api/events';
import type { UpcomingEvent, PastEvent, FeaturedEvent } from '@/features/events/api/events';
...
export default function EventsPage() {
    ...
    return <main>
      ...
      <div className="w-full max-w-4xl mx-auto rounded-lg overflow-hidden min-h-[400px] sm:min-h-[700px] sm:p-0">
      <HeroSection title="Events" subtitle="See what is happening in our UTMIST community" />
          <iframe
            ...
            style={{ border: 0 }}
            className="google-calendar-embed w-full h-full min-h-[400px] sm:min-h-[700px] p-8"
            frameBorder="0"
            scrolling="no"
          />
        </div>
