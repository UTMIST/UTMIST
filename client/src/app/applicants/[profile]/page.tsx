...
export default function ApplicantProfile() {
  ...
  const hideScheduleButton = ["Scheduled", "Finished"].includes(
    ...
    <div className="w-full min-h-screen px-0 py-0 relative">
      <div className="max-w-4xl mx-auto pt-12 pb-8 px-8">
        ...
        <div className="text-xl text-gray-700 font-semibold mb-2">
          Role:
          <span className="font-semibold text-blue-700">{applicant.role}</span>
        </div>

        <div className="flex flex-wrap items-center gap-8 mb-8">
          <div
            className={`px-4 py-2 rounded-lg text-base font-semibold shadow-sm ${
              applicant.interviewStatus === "Scheduled" ||
              applicant.interviewStatus === "Finished"
        ...
        <div className="flex gap-6 mb-10">
          {!hideScheduleButton && (
            <button className="bg-indigo-600 hover:bg-indigo-700 text-white px-8 py-4 rounded-xl text-lg font-bold shadow transition-colors duration-200">
              Schedule Interview
            </button>
          )}
          <button className="border-2 border-[#6B66E3] bg-gradient-to-l from-[#6B66E3] to-[#1E19B1] px-4 py-2 hover:bg-white dark:hover:bg-[#1a1f30] hover:text-[#6B66E3] dark:hover:text-[#8b87f5] rounded-2xl cursor-pointer text-lg font-bold shadow hover:[background-image:none] text-white transition-colors duration-200">
            Accept
          </button>
          <button className="border-2 border-[#6B66E3] bg-white dark:bg-[#1a1f30] text-[#6B66E3] dark:text-[#8b87f5] hover:bg-[#6B66E3] cursor-pointer hover:text-white px-4 py-2 rounded-2xl text-lg font-bold shadow transition-colors duration-200">
            Reject
          </button>
          <button className="border-2 border-[#6B66E3] hover:bg-white dark:hover:bg-[#1a1f30] cursor-pointer hover:text-[#6B66E3] dark:hover:text-[#8b87f5] px-4 py-2 rounded-2xl text-lg bg-[#6B66E3] text-white font-bold shadow transition-colors duration-200">
            Waitlist
          </button>
        </div>
        <div className="pr-8 pt-8 pb-8 mb-6">
          <div className="mb-2 flex items-center text-lg">
            ...
            <a
              href={
                "https://mvmrwmtxepoyoueoiedh.supabase.co/storage/v1/object/sign/Meals/A%20Shubham's%20Resume.pdf?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV83ZGQzMTU2ZS1hODE4LTQxOTMtYThkZi00NzZhYTUxYzZmMjUiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJNZWFscy9BIFNodWJoYW0ncyBSZXN1bWUucGRmIiwiaWF0IjoxNzU4MzI0NTkwLCJleHAiOjE3ODk4NjA1OTB9.D3Qswo981fig8crwcgtFhu04Odg1hmjujPvx9F5kY3M"
              }
              target="_blank"
        ...
        <div className="bg-white border border-blue-100 rounded-2xl p-8 mb-6 shadow">
          <div className="mb-4 font-bold text-lg text-blue-700">
            Leave Notes:
          </div>
          <textarea
          ...
          />
          <button className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-xl text-lg font-bold shadow transition-colors duration-200">
            Save Notes
          </button>
        </div>
      </div>
