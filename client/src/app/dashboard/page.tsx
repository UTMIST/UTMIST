    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[var(--background)]">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-[var(--gray4)] font-[var(--system-font)]">
            Loading...
          </span>
        </div>
      </div>
          ...
          <div className="flex justify-between items-center py-6">
            ...
            <div className="flex items-center space-x-4">
              <button
                ...
                className="px-4 py-2 text-sm font-medium text-[var(--gray4)] hover:text-red-600 transition-colors"
              >
                Sign Out
              </button>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            ...
            <div className="space-y-3">
              <div>
                <label className="text-sm font-medium text-[var(--gray4)]">
                  Email
                </label>
                <p className="text-black font-[var(--system-font)]">
                  {user.email}
                </p>
              </div>
              {profile?.name && (
          ...
          <div className="bg-white p-6 rounded-2xl border border-[var(--gray3)] shadow-sm">
            ...
            <div className="space-y-3">
              ...
              >
                <span className="text-black font-[var(--system-font)]">
                  View Events
                </span>
              </button>
              <button
          ...
          <div className="bg-white p-6 rounded-2xl border border-[var(--gray3)] shadow-sm">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-black font-bold">Supabase</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-[var(--gray4)] font-[var(--system-font)]">
                  Database
