      ...
      <div className="bg">
        ...
        <div className="hero-section">
          ...
          <p className="hero-subtitle">
            (Brought to you by the Academics Department)
          </p>
        ...
        <section className="intro items-center md:items-start max-w-4xl mx-auto px-4">
          <div className="flex flex-col justify-center gap-">
            <div className="flex justify-center">
              <Image className="h-64 w-auto" src={ai2Logo} alt="AI2 Logo" />
            </div>
            <h1 className="ai2-h1">Join us for an incredible experience</h1>
            <p className="px-6 sm:px-8 md:px-0">
              Welcome back for UTMIST AI Squared 2025 Fall Split! Centered
              around groups of participants competing to design the best AI
              agent in a custom platform fighting game, AI Squared brings
              together individuals of all skill levels in a encouraging learning
              environment filled with fun and excitement!
            </p>
            <p className="px-6 sm:px-8 md:px-0">
              There will be workshops, speakers, as well as the grand finals.
              The tournament will be held in an double elimination bracket
              format of consecutive rounds of agents facing off 1v1 until the
              winner is crowned. Who will stand tall? Will it be you?
            </p>
          </div>
        </section>
        ...
        <section className="how-it-works">
          ...
          {aiSquaredDetails.map((step: StepDetail, i: number) => (
            <div
              ...
              style={{
                background:
                  "radial-gradient(circle, rgba(103,128,253,0.2) 0%, rgba(103,128,253,0) 100%)",
              }}
            >
              <Image
                src={step.image}
          ...
          <h2 className="ai2-h2 text-center">
            Find our open-source environment and server code{" "}
            <a
              href="https://github.com/UTMIST/UTMIST-AI2"
              target="_blank"
        ...
        <section className="timeline py-10 md:py-16 timeline-section">
          ...
          <div className="bg-white flex flex-col sm:flex-row gap-3 sm:gap-5 justify-center items-center mx-auto py-4 sm:py-6 rounded-xl sm:rounded-full w-full sm:w-fit px-4">
            {["October 25", "October 25 - November 1", "November 2"].map(
              (label: string) => (
                <button
                  key={label}
          ...
          <div className="mt-10 mb-4 text-center">
            <div
              ...
              style={{
                background:
                  "linear-gradient(90deg, rgba(106,102,245,0.12), rgba(106,102,245,0.06) 50%, rgba(106,102,245,0.12))",
                boxShadow: "0 6px 18px rgba(106,102,245,0.06)",
              }}
            >
              {activeButton === "October 25" && (
                <h2 className="ai2-h2 m-0">Kickoff</h2>
              )}
              {activeButton === "October 25 - November 1" && (
                <h2 className="ai2-h2 m-0">Agent Development</h2>
              )}
              {activeButton === "November 2" && (
                <h2 className="ai2-h2 m-0">Expo</h2>
              )}
            </div>
          </div>
              ...
              return (
                <Chrono
                  ...
                  theme={{
                    ...
                    secondary: isDark ? "#1a1f30" : "#ffffff",
                    titleColor: isDark ? "#e0e0e0" : "#000000",
                    titleColorActive: isDark ? "#ffffff" : "#000000",
                    cardBgColor: isDark ? "#1a1f30" : "#ffffff",
                    cardTitleColor: isDark ? "#e0e0e0" : "#000000",
                    cardSubtitleColor: isDark ? "#c0c0c0" : "#000000",
                    cardDetailsColor: isDark ? "#a0a0a0" : "#000000",
        ...
        <section className="mx-auto mb-16">
          ...
          <div className="mt-8 grid grid-cols-2 gap-8 justify-items-center justify-center w-fit mx-auto gap-x-16">
            {sponsorsLogos.map((sponsor, idx) => (
              <div key={idx} className="flex flex-col items-center text-center">
                <a href={sponsor.url}>
                  <div className="w-40 h-30 flex items-center justify-center mb-8">
                    <Image
                      src={sponsor.image}
          ...
          <div className="mt-10 items-center max-w-4xl mx-auto px-4 flex flex-col justify-center gap-4 pl-2 pr-2 text-center">
            ...
            <p>
              None of our work would be possible without our sponsors. They
              unite developers, designers, and ML enthusiasts globally with
              connections that go beyond the tournament. Keep checking back for
              our sponsors for AI Squared Fall 2025!
            </p>
            <h2 className="ai2-h2">Want to help bring AI Squared to life?</h2>
            <p>
              Shoot us an email at{" "}
              <a
                href="mailto:partnerships@utmist.skule.ca"
                target="_blank"
                rel="noopener noreferrer"
                className="underline"
              >
                partnerships@utmist.skule.ca
              </a>
              !
            </p>
          </div>
        ...
        <section className="speakers items-center max-w-2xl mx-auto px-4 text-center mb-16">
          <div className="gap-4">
            ...
            <h3 className="speakers-section-subtitle text-2xl md:text-3xl lg:text-4xl">
              <i>Intro to the RL Paradigm</i>
            </h3>
            <PeopleGrid people={[ai2speakers[0]]} />
            <h3 className="speakers-section-subtitle text-2xl md:text-3xl lg:text-4xl">
              <i>How the Gaming Inustry Is Shifting to Agents</i>
            </h3>
            <PeopleGrid people={[ai2speakers[1]]} />
            <h3 className="speakers-section-subtitle text-2xl md:text-3xl lg:text-4xl">
              <i>Deploying neural networks on Tenstorrent Hardware</i>
            </h3>
            <PeopleGrid people={[ai2speakers[2]]} />
            <h3 className="speakers-section-subtitle text-2xl md:text-3xl lg:text-4xl">
              <i>Designing AI for Fun in Games</i>
            </h3>
        ...
        <section className="speakers items-center max-w-2xl mx-auto px-4 text-center mb-16">
          <div className="gap-4">
            ...
            <h3 className="speakers-section-subtitle text-2xl md:text-3xl lg:text-4xl">
              <i>
                AI & Gaming Industry Panel: Applications of Machine Learning in
                Video Games
              </i>
            </h3>
