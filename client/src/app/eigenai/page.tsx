    ...
    <main className="sm:items-start sm:justify-center">
      ...
      <div className="hero-section">
        ...
        <p className="hero-subtitle">
          Help shape the future of AI and ML @ UTMIST
        </p>
      </div>
      ...
      >
        <div className="w-full lg:w-1/2 max-w-md lg:max-w-lg">
          ...
          <h3 className="intro-section-subtitle">
            September 20-21, 2025 | In-Person @ OISE, UofT
          </h3>
          <p className="intro-section-description">
            EigenAI is a UTMIST flagship conference introducing students to the
            world of AI, ML, software, and emerging technologies. Through panels
            and workshops covering both fundamental and advanced topics,
            participants gain hands-on experience and practical insights. This
            year’s theme is Mapping AI through the Multiverse, which invites
            students to journey through the many dimensions of AI, allowing them
            to explore the field from multiple perspectives and hear from
            professionals across diverse industries. Beyond technical talks and
            workshops, students have the opportunity to build their professional
            network and connect with industry leaders, academic professionals,
      ...
      <section className="people-section px-4 md:px-8">
        ...
        <h3 className="people-section-subtitle text-2xl md:text-3xl lg:text-4xl">
          <i>Agentic AI and The Future of Everything</i>
        </h3>
        <PeopleGrid people={[speakerSession[0]]} />
        <h3 className="people-section-subtitle text-2xl md:text-3xl lg:text-4xl">
          <i>
            Responsible AI 101: Building Trust in Tomorrow&apos;s Technology
          </i>
        </h3>
        <PeopleGrid people={[speakerSession[1]]} />
        <h3 className="people-section-subtitle text-2xl md:text-3xl lg:text-4xl">
          <i>The Silent Layer: Privacy and Security at the Core of AI</i>
        </h3>
      ...
      <section className="people-section px-4 md:px-8">
        ...
        <h3 className="people-section-subtitle text-2xl md:text-3xl lg:text-4xl">
          <i>Founders, Funders, and Future AI</i>
        </h3>
        <PeopleGrid people={founderPanelSpeakers} />
        <h3 className="people-section-subtitle text-2xl md:text-3xl lg:text-4xl">
          <i>From Classroom to Lab: Undergraduate Research Journeys</i>
        </h3>
