...
export default function AuthPage() {
  ...
  useEffect(() => {
    const checkAuth = async () => {
      ...
      if (user) {
        console.log(
          "Auth page: User already authenticated, redirecting to dashboard"
        );
        setRedirecting(true);
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 bg-[var(--background)]">
      <div className="w-full max-w-md">
        <div
          className={`bg-white p-8 rounded-2xl border border-[var(--gray3)] shadow-sm ${
            isLogin ? "space-y-6" : "space-y-8"
          }`}
        >
