        ...
        <section className="py-16 md:py-24" style={{ fontFamily: 'var(--system-font)' }}>
            <div className="max-w-7xl mx-auto px-4 md:px-16">
                ...
                <div className="text-center mb-12 md:mb-16">
                    ...
                    <p className="text-lg leading-7 text-gray-600 font-sans mb-8 text-center w-full" >
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-lg border border-blue-100">
                        ...
                        <h3 className="font-bold mb-2">Cofounders</h3>
                ...
                <div className="text-center shadow-lg">
                    <div className="bg-white shadow-lg border border-blue-100 rounded-2xl p-6 md:p-12">
                        ...
                        <p className="w-full text-lg leading-7 text-gray-600 font-sans mb-8 text-center">
